    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <Grid container>
        ...
        <Grid item justifyContent="flex-end" xs={2}>
          <Button onClick={handleCreateOpen} variant='contained' size='small'><Add/> &nbsp;Create Invoice</Button>
        </Grid> 
        <Grid item xs={12}>
        <DataGrid
        rows={rows}
      ...
      />
        ...
        <CreateInvoiceModal open={createInvoiceModal} setOpen={setCreateInvoiceModal}/>
      </Grid>
